...
function num2str(count) {
    if (count > 10000) {
        return parseInt(count / 10000) + "k";
    }
    if (count > 500) {
        return parseInt(count / 1000) + "k";
    }
    if (count === 0) { // Use '===' instead of '=' for comparison
        return "";
    }
    return count;
}
                            ...
                            <div class="box" id="${post["_id"]}">
                                <article class="media">
                                    ...
                                    <div class="media-content">
                                        <div class="content">
                                            <p>
                                                <strong>${post["profile_name"]}</strong> <small>@${post["nickname"]}</small> <small>${time_before}</small>
                                                <br>
                                                ${post["comment"]}
                                            </p>
                                        </div>
